...
<head>
    ...
    <!-- importando jquery para calendario-->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="/pages/pagination2">Recusadas</a>   
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">Retorno ao cliente</h6>
                        <a class="dropdown-item" href="/pages/paginationRetorno">Vendidas</a> 
                        <a class="dropdown-item" href="/pages/paginationRetorno1">Não Vendidas</a>
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">Relatórios</h6>
                        <a class="dropdown-item" href="/dashboard/ralatorioPorPeriodo">Por período</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="/opcoes/listauser">Usuários</a>
            ...
            <form class="form-inline my-2 my-lg-0" action="/pages/search" method="post">
                <input class="form-control mr-sm-2" name="search" type="text" placeholder="Buscar Viabilidade" aria-label="Search" required>
            ...
            <ul class="navbar-nav my-2 my-lg-0 "
                ...
                <li class="nav-item active navbar-right">
                    <a class="nav-link" href="/opcoes/editUserUser"><?php $user = $this->session->userdata('user');; echo $user->name;?></a>
                </li>
            </ul>
