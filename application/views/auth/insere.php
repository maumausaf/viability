...
<p>Por favor, preencha os dados abaixo, para verificarmos a possibilidade de atendelo.</p>
<hr>
...
<form action="/auth/insere" method="post" >
    ...
    <div class="form-group col-md-12">
        ...
        <textarea type="text" name="informacoes" class="form-control" placeholder="Exemplo: Referência do endereço."></textarea>
    </div>     
