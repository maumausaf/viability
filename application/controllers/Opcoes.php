...
class Opcoes extends CI_Controller {
    ...
    {   
        ...
        if($user->user == $grauUser){
            ...
            $this->form_validation->set_rules('user', 'Função do Usuário', 'required');
   ...
   public function listaUser() {
    ...
    public function editUser($id = null) {
        ...
        if($this->form_validation->run() === false){
            ...
            $this->load->view('template/header');
            $this->load->view('opcoes/edit_user_adm',['user'=> $page]);       
            $this->load->view('template/footer');
        }else{
            $data['back'] = '/opcoes/listaUser';
    ...
    public function editUserUser() {
        ...
        if($this->form_validation->run() === false){
            ...
            $this->load->view('template/header');
            $this->load->view('opcoes/edit_user_user',['user'=> $page]);       
            $this->load->view('template/footer');
        }else{
            $data['back'] = '/opcoes/listaUser';
